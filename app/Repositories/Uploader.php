...
//
    ...
    public function storeImage($folder, $file_name, $is_file = null)
    {
        if ($is_file) {
            $file = $file_name;
        } else {
        ...
        $save = Storage::disk('local')->put($filePath, $file);
        return str_replace("public/", "", $save);
    }
    ...
    public function removeImage($path)
    {
        ...
        $file_path = base_path('storage/app/public' . '/' . $path);
