            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{url(admin_part_url().'/'.$surah_id.'/create')}}"
                        ...
                        <!--end::Button-->
                        <a href="{{url(admin_part_url().'/'.$surah_id."/tree")}}"
                           class="btn btn-primary font-weight-bolder ml-3">
											<span class="svg-icon svg-icon-md">
												<!--begin::Svg Icon | path:assets/media/svg/icons/Design/Flatten.svg-->
												<svg xmlns="http://www.w3.org/2000/svg"
                                                     xmlns:xlink="http://www.w3.org/1999/xlink" width="24px"
                ...
                <!--end::Search Form-->
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-separate table-head-custom collapsed" id="part_tbl">
                            <thead>
                            <tr>
                                ...
                                <th title="Field #7">الخرائط الفرعية</th>
                            </tr>
                            </thead>
