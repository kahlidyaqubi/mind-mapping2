            ...
            <div class="card card-custom">
                        ...
                        <div class="row align-items-center">
                            <div class="col-md-9">
                                <div class="row align-items-center">
                                    ...
                                    <div class="col-md my-2 my-md-0">
                                        <div class="input-group">
                                            <select class="form-control select2" name="country_id_filter"
                                                    id="country_id_filter">
                                                <option value="" disabled="disabled" selected>الدولة</option>
                                                @foreach($countries as $country)
                                                    <option value="{{$country->id}}"
                                                            {{request('country_id')&&request('country_id')==$country->id?'selected':''}}>{{$country->name}}</option>
                                                @endforeach
                                            </select>
                                        </div>
                                    </div>
                ...
                <!--end::Search Form-->
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-separate table-head-custom collapsed" id="user_tbl">
                            <thead>
                            <tr>
                                <th title="Field #1">#</th>
                                <th title="Field #3">الاسم</th>
                                <th title="Field #3">الهاتف</th>
                                <th title="Field #4">الدولة</th>
                                <th title="Field #4">مستوى الحفظ</th>
                                <th title="Field #4">العمر</th>
