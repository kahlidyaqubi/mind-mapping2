            ...
            <div class="card card-custom">
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    ...
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="{{url(admin_reciter_url().'/create')}}"
                ...
                <!--end::Search Form-->
                    ...
                    <div class="portlet-body">
                        ...
                        <table class="table table-separate table-head-custom collapsed" id="reciter_tbl">
                            <thead>
                            <tr>
                                <th title="Field #1">#</th>
...
@stop
@section('js')
    <script src="{{assets_url('admin')}}/js/reciters.js" type="text/javascript"></script>
